...
const Login = () => {
    ...
    return (
        <Box sx={containerStyle}>
            ...
            <Box sx={cardStyle}>
                <Box sx={badgeStyle}>🚀 Premium Access</Box>
                <Typography component="h1" sx={headerStyle}>Job-Ready AI</Typography>
                <Typography component="p" sx={subheaderStyle}>Boost your interview skills and claim your dream developer job offer</Typography>
                ...
                <Typography component="p" sx={footerTextStyle}>
                    Don't have an account? <Link to={"/register"} style={linkStyle}>Register Now</Link>
                </Typography>
            </Box>
        </Box>
    )
